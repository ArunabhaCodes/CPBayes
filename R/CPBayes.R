...
#' \item{\code{\link{estimate_corln}}}{This function computes an approximate correlation matrix of
#'  the beta-hat vector for multiple overlapping case-control studies or a cohort study using the
#'  sample-overlap matrices. The estimated correlation matrix can be passed as an argument
#'   into \code{\link{cpbayes_cor}}.}
#' }
