...
1. analytic_locFDR_BF_uncor: It analytically computes the local FDR (locFDR) and Bayes factor (BF) quantifying the evidence of aggregate-level pleiotropic association for uncorrelated summary statistics.
1. analytic_locFDR_BF_cor: It analytically computes the local FDR (locFDR) and Bayes factor (BF) for correlated summary statistics. 
